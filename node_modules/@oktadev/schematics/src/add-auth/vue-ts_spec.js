...
const vue_ts_pkg_json_1 = __importDefault(require("./vue-ts-pkg.json"));
...
describe('OktaDev Schematics: Vue + TypeScript', () => {
    ...
    it('works', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Add package.json
        tree.create('/package.json', JSON.stringify(vue_ts_pkg_json_1.default));
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
...
//# sourceMappingURL=vue-ts_spec.js.map